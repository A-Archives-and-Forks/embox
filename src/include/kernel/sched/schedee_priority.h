...
#define SCHED_PRIORITY_QUNTITY           (99)
#define SCHED_LT_PRIORITY_QUNTITY   (55)

#define SCHED_PRIORITY_MIN       (0) /* only system Idle */
#define SCHED_PRIORITY_MAX       (255)
#define SCHED_PRIORITY_TOTAL     (SCHED_PRIORITY_MAX - SCHED_PRIORITY_MIN + 1)

#define SCHED_OTHER_PRIORITY_MIN  SCHED_PRIORITY_MIN + 1
#define SCHED_OTHER_PRIORITY_MAX  \
					(SCHED_OTHER_PRIORITY_MIN + SCHED_PRIORITY_QUNTITY)
#define SCHED_OTHER_PRIORITY_NORM \
					((SCHED_OTHER_PRIORITY_MAX + SCHED_OTHER_PRIORITY_MIN) / 2)

#define SCHED_RT_PRIORITY_MIN   (SCHED_OTHER_PRIORITY_MAX + 1)
#define SCHED_RT_PRIORITY_MAX   (SCHED_RT_PRIORITY_MIN + SCHED_PRIORITY_QUNTITY)
#define SCHED_RT_PRIORITY_NORM \
					((SCHED_RT_PRIORITY_MAX + SCHED_RT_PRIORITY_MIN) / 2)

#define SCHED_LT_PRIORITY_MIN   (SCHED_RT_PRIORITY_MAX + 1)
#define SCHED_LT_PRIORITY_MAX   (SCHED_LT_PRIORITY_MIN + (SCHED_LT_PRIORITY_QUNTITY))
#define SCHED_LT_PRIORITY_NORM \
					((SCHED_LT_PRIORITY_MAX + SCHED_LT_PRIORITY_MIN) / 2)
